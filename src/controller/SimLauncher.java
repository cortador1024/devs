...
import facade.modeling.CCAmodeling.FCCAsSpaceModel;
    ...
    implements ControllerInterface, SimulatorHookListener
{
    ...
    public void userGesture(String gesture, Object params)
    {
        try
        {
            ...
            else if (gesture.equals(SIM_RESET_GESTURE))
            {
				...
				else if (view.isCCASelected())
				{
					view.getCcatracking().getCAView().reset();
				}
    ...
    public void postComputeInputOutputHook()
    {
        ...
        if (view.isTrackingEnabled() || view.isCASelected() || view.isCCASelected())
        {
    ...
    public void initializeSimulator(LoadedDevsModel metadata)
    {
        ...
        {
            CCAsSpaceModel model = (CCAsSpaceModel) metadata.instanceModel;
            
            rootModel = new FCCAsSpaceModel(model);

            simulator = new FCCASimulator(model, rootModel, SimView.modelView, metadata.modelType);
        }
        else
        {
        ...
        {
            view.getCcatracking().loadSimModel(rootModel);
        }
