...
public class SimulatorController extends ViewableDigraph{
  ...
  public SimulatorController() {
    ...
    {
        preferredSize = new Dimension(797, 532);
        ((ViewableComponent)withName("Cs1")).setPreferredLocation(new Point(383, 25));
        ((ViewableComponent)withName("Cs0")).setPreferredLocation(new Point(12, 195));
        ((ViewableComponent)withName("Cs3")).setPreferredLocation(new Point(383, 363));
        ((ViewableComponent)withName("Cs2")).setPreferredLocation(new Point(383, 195));
    }
}
