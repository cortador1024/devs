...
public class TransformatorFail extends ViewableAtomic {
  ...
  public TransformatorFail ( String n, int e, double t0, double t1 ) {
    super ( String. format ( "Trasnformator Fail %s", n ) );
    addOutport ( "out" );
    addInport ( "in" );
