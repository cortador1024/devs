...
public class AgentSpace extends TwoDimCellSpace {
	...
	private final String[] statusCXCL12 = {  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "CXCL12" };
	private final String[] statusCXCLR4 = {  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "CXCR4" };
	private final String[] statusCXCLR7 = {  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "EMPTY",  "EMPTY",  "EMPTY",  "EMPTY", "CXCR7" };
